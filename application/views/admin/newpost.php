<?php $this->load->view('admin/include/head'); ?>
    ...
    <div id="wrapper">
		...
		function cekFile() {
		   ...
		   var cekjam = document.forms['f']['jam'].value;
		     if(
			 	cekjudul==null || 
				cekjudul=="")
		     {
                ...
                <div class="row">
                	<div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                        	...
                        	<?php echo form_open('tabelpost/simpan', 'name="f" onSubmit="return cekFile()"'); ?>
                            ...
                            <table class="table table-striped">
							  <tbody>
								...
								<tr>
								  	...
								  	<td colspan="3">
								  		<select class="form-control" name="kate">
											<?php
											foreach ($sql->result_array() as $ro)
											{ if($kategori==$ro['cat_id']){ ?>
												<option value="<?php echo $ro['cat_id']; ?>" selected="selected"><?php echo ucwords($ro['nama']); ?></option>
											<?php }else{ ?>
												<option value="<?php echo $ro['cat_id']; ?>"><?php echo ucwords($ro['nama']); ?></option>
											<?php } } ?>
										  </select>
									</td>
								</tr>
								...
								<tr>
								  <td>DateTime</td>
								  <td style="width:10px">
								  	<input type="text" class="form-control" name="tgl" onclick="ooo();" id="datepicker" style="text-align:center;width:200px" autocomplete="off" value="<?php echo $tgl; ?>"/>
									</td>
								  <td colspan="2" >
								  	<input type="text" class="form-control" name="jam" style="text-align:center;width:200px" onclick="ooo();" value="<?php echo $jam; ?>"/>
								  </td>
...
function ooo(){
    var d2 = document.f.jam.value;
	if(d2==""){
		var d = new Date,
			dformat =  [ d.getHours().padLeft(),
						d.getMinutes().padLeft(),
						d.getSeconds().padLeft()].join(':');
		 document.f.jam.value=dformat;
	 }
};
